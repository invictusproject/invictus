...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Invictus", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Invictus";
        CTransaction txNew;
        txNew.nTime = 1464971300;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1464971300;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2298546;
        ...
        assert(block.hashMerkleRoot == uint256("0x539d0eb9a7c5272cb73f60730b37c2f5710bbf99c223e2df859609385d5b8bff"));
...
unsigned char pchMessageStart[4] = { 0xb5, 0xb2, 0xa2, 0xa3 };
